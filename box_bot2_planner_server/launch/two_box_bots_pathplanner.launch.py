...
def generate_launch_description():
    ...
    default_nav_to_pose_bt_xml_box_bot_1 = os.path.join(get_package_share_directory(
    'box_bot2_planner_server'), 'config', 'box_bot_1_behavior.xml')
    controller_yaml_box_bot_1 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'controller_box_bot_1.yaml')
    bt_navigator_yaml_box_bot_1 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'bt_navigator_box_bot_1.yaml')
    planner_yaml_box_bot_1 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'planner_server_box_bot_1.yaml')
    recovery_yaml_box_bot_1 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'recovery_box_bot_1.yaml')

    waypoints_yaml_box_bot_1 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'waypoint_follower_box_bot_1.yaml')

    default_nav_to_pose_bt_xml_box_bot_2 = os.path.join(get_package_share_directory(
    'box_bot2_planner_server'), 'config', 'box_bot_2_behavior.xml')
    controller_yaml_box_bot_2 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'controller_box_bot_2.yaml')
    bt_navigator_yaml_box_bot_2 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'bt_navigator_box_bot_2.yaml')
    planner_yaml_box_bot_2 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'planner_server_box_bot_2.yaml')
    recovery_yaml_box_bot_2 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'recovery_box_bot_2.yaml')
    waypoints_yaml_box_bot_2 = os.path.join(get_package_share_directory(
        'box_bot2_planner_server'), 'config', 'waypoint_follower_box_bot_2.yaml')

    box_bot_1_rviz_config_dir = os.path.join(
        get_package_share_directory('box_bot2_cartographer_slam'),
        'rviz',
        'box_bot_1_view.rviz')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='bt_navigator',
            output='screen',
            parameters=[bt_navigator_yaml_box_bot_1, {"default_nav_to_pose_bt_xml": default_nav_to_pose_bt_xml_box_bot_1}]),
        ...
        Node(
            ...
            name='bt_navigator',
            output='screen',
            parameters=[bt_navigator_yaml_box_bot_2, {"default_nav_to_pose_bt_xml": default_nav_to_pose_bt_xml_box_bot_2}]),
